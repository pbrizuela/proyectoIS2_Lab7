 ...
 */
@javax.ejb.Stateless
@Path("com.example.usuarios")
public class UsuariosFacadeREST extends AbstractFacade<Usuarios> {

    @PersistenceContext(unitName = "getsomerestPU")
    ...
    protected EntityManager getEntityManager() {
        return em = Persistence.createEntityManagerFactory("getsomerestPU").createEntityManager();
